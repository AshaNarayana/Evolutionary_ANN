...
if __name__ == "__main__":
    ...
    X_train, X_val, X_test, y_train, y_val, y_test = generator_base.split_data(X, y, training_size=0.5)
    ...
    X_train, X_val, X_test, y_train, y_val, y_test = generator_larger.split_data(X, y, training_size=0.5)
    ...
    X_train, X_val, X_test, y_train, y_val, y_test = generator_noisy.split_data(X, y, training_size=0.5)
